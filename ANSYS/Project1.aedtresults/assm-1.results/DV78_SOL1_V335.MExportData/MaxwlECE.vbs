...
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", "ECE3_Model", _
  "Id:=", "322"), Array("NAME:Attributes", "Page:=", 1, "X:=", 0, "Y:=", 0, _
  "Degrees:=", 0, "Flip:=", false) 
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@ECE3_Model;322;0"), Array(_
...
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", "ECER_Model", _
  "Id:=", "329"), Array("NAME:Attributes", "Page:=", 1, "X:=", 0.0127, "Y:=", _
  0, "Degrees:=", 0, "Flip:=", false) 
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@ECER_Model;329;0"), Array(_
...
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  ...
  "Value:=", "2"))))
oEditor.CreateGround Array("NAME:GroundProps", "Id:=", "315"), Array(_
