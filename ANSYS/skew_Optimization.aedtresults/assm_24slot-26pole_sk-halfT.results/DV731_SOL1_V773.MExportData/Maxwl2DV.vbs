...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "Load Torque:=", _
  "if(speed<282.743, -0.588035*speed, -47009.8/speed) - 0.588035*(speed-282.743)*10", _
  "Objects:=", Array("Band"))
