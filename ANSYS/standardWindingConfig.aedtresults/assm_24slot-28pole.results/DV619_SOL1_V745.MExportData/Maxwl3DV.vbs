...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "DiaGap", "Value:=", "277.45mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "100mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "89.39524649397829mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "277.45mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "429.8mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "89.39524649397829mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
  "Value:=", "0deg"), Array("NAME:Pair", "Name:=", "Fractions", "Value:=", _
...
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "OuterRegion:CreateUserDefinedPart:1", "Length", "41.2mm + 2*endRegion"
On Error Goto 0
oEditor.SetPropertyValue "Geometry3DCmdTab", _
...
oModule.AssignMaster Array("NAME:Master", "Objects:=", Array("MasterSheet"), _
  ...
  "UPos:=", Array("214.90000000000001mm", "0mm", "0mm")), "ReverseV:=", true)
oModule.AssignSlave Array("NAME:Slave", "Objects:=", Array("SlaveSheet"), _
  Array("NAME:CoordSysVector", "Origin:=", Array("0mm", "0mm", "0mm"), _
  "UPos:=", Array("1.315882985683831e-14mm", "214.90000000000001mm", "0mm")), _
  "ReverseV:=", true, "Master:=", "Master", "RelationIsSame:=", false)
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/SlotCore", "Version:=", "12.1", "NoOfParameters:=", 19, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "278.1mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "429.8mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "41.2mm"), Array("NAME:Pair", "Name:=", "Skew", "Value:=", _
  ...
  Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "48.7mm"), Array("NAME:Pair", _
  "Name:=", "Bs0", "Value:=", "16.1mm"), Array("NAME:Pair", "Name:=", "Bs1", _
  "Value:=", "19.3481888906285mm"), Array("NAME:Pair", "Name:=", "Bs2", _
  "Value:=", "32.17114215564085mm"), Array("NAME:Pair", "Name:=", "Rs", _
  ...
  "Name:=", "LenRegion", "Value:=", "89.39524649397829mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "2mm"), Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "48.7mm"), _
  Array("NAME:Pair", "Name:=", "Bs0", "Value:=", "16.1mm"), Array("NAME:Pair", _
  "Name:=", "Bs1", "Value:=", "19.3481888906285mm"), Array("NAME:Pair", _
  "Name:=", "Bs2", "Value:=", "32.17114215564085mm"), Array("NAME:Pair", _
  ...
  "Value:=", "89.39524649397829mm"), Array("NAME:Pair", "Name:=", "InfoCoil", _
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_0:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/LapCoil", "Version:=", "12.0", "NoOfParameters:=", 21, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_1:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_2:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_3:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_4:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_5:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_6:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_7:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_8:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_9:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_10:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_11:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "276.8mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "100mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "41.2mm"), Array("NAME:Pair", "Name:=", "Poles", "Value:=", "28"), _
  Array("NAME:Pair", "Name:=", "PoleType", "Value:=", "2"), Array("NAME:Pair", _
  "Name:=", "D1", "Value:=", "274.8mm"), Array("NAME:Pair", "Name:=", "O1", _
  "Value:=", "0mm"), Array("NAME:Pair", "Name:=", "O2", "Value:=", _
  "69.08877183138307mm"), Array("NAME:Pair", "Name:=", "B1", "Value:=", _
  "18mm"), Array("NAME:Pair", "Name:=", "Rib", "Value:=", "2mm"), Array(_
  "NAME:Pair", "Name:=", "HRib", "Value:=", "17.66671872653491mm"), Array(_
  "NAME:Pair", "Name:=", "DminMag", "Value:=", "0mm"), Array("NAME:Pair", _
  "Name:=", "ThickMag", "Value:=", "18mm"), Array("NAME:Pair", "Name:=", _
  "WidthMag", "Value:=", "18.1mm"), Array("NAME:Pair", "Name:=", "LenRegion", _
  "Value:=", "89.39524649397829mm"), Array("NAME:Pair", "Name:=", "InfoCore", _
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "InnerRegion:CreateUserDefinedPart:1", "LenRegion", "41.2mm + 2*endRegion"
On Error Goto 0
Set oModule = oDesign.GetModule("MeshSetup")
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "61.2mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oEditor.Move Array("NAME:Selections", "Selections:=", "CoilTerm_0,CoilTerm_1" & _
  ...
  "TranslateVectorZ:=", "10.300000000000001mm")
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2700rpm", "Moment of Inertia:=", 0.185206, "Damping:=", 0.00264044, _
  "Load Torque:=", _
  "if(speed<282.743, -0.588055*speed, -47011.3/speed) - 0.588055*(speed-282.743)*10", _
  "Objects:=", Array("Band"))
