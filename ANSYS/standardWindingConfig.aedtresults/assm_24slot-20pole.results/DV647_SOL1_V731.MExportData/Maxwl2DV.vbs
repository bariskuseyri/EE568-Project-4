...
edgeID = oEditor.GetEdgeByPosition(Array("NAME:Parameters", "BodyName:=", _
  "OuterRegion", "XPosition:=", "1.2439349862339241e-14mm", "YPosition:=", _
  "203.15000000000001mm", "ZPosition:=", "0mm"))
oModule.AssignVectorPotential Array("NAME:VectorPotential1", "Edges:=", Array(edgeID), _
  "Value:=", "0", "CoordinateSystem:=", "")
edgeID = oEditor.GetEdgeByPosition(Array("NAME:Parameters", "BodyName:=", _
  "OuterRegion", "XPosition:=", "101.575mm", "YPosition:=", "0mm", _
  "ZPosition:=", "0mm"))
oModule.AssignMaster Array("NAME:Master1", "Edges:=", Array(edgeID), _
  "ReverseV:=", false)
edgeID = oEditor.GetEdgeByPosition(Array("NAME:Parameters", "BodyName:=", _
  "OuterRegion", "XPosition:=", "-101.575mm", "YPosition:=", _
  "1.2439349862339241e-14mm", "ZPosition:=", "0mm"))
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "Hs2", "Value:=", "45.5mm"), Array("NAME:Pair", "Name:=", "Bs0", _
  "Value:=", "15.1mm"), Array("NAME:Pair", "Name:=", "Bs1", "Value:=", _
  "18.37315590756558mm"), Array("NAME:Pair", "Name:=", "Bs2", "Value:=", _
  "30.3535331880186mm"), Array("NAME:Pair", "Name:=", "Rs", "Value:=", "5mm"), _
...
oModule.AssignCoil Array("NAME:PhCRe_5", "Objects:=", Array("Coil_10"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseC")
oModule.AssignCoil Array("NAME:PhARe_6", "Objects:=", Array("Coil_11"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseA")
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
...
oEditor.Unite Array("NAME:Selections", "Selections:=", "Mag_0,Mag_10"), Array(_
...
oEditor.Unite Array("NAME:Selections", "Selections:=", "Mag_1,Mag_11"), Array(_
  "NAME:UniteParameters", "CoordinateSystemID:=", -1, "KeepOriginals:=", _
  false)
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oEditor.Unite Array("NAME:Selections", "Selections:=", "Mag_2,Mag_12"), Array(_
  "NAME:UniteParameters", "CoordinateSystemID:=", -1, "KeepOriginals:=", _
  false)
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  "CoordinateSystemID:=", -1, "OriginX:=", "0", "OriginY:=", "0", "OriginZ:=", _
...
oEditor.Unite Array("NAME:Selections", "Selections:=", "Mag_3,Mag_13"), Array(_
  "NAME:UniteParameters", "CoordinateSystemID:=", -1, "KeepOriginals:=", _
  false)
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oEditor.Unite Array("NAME:Selections", "Selections:=", "Mag_4,Mag_14"), Array(_
  "NAME:UniteParameters", "CoordinateSystemID:=", -1, "KeepOriginals:=", _
  false)
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  "CoordinateSystemID:=", -1, "OriginX:=", "0", "OriginY:=", "0", "OriginZ:=", _
...
oEditor.Unite Array("NAME:Selections", "Selections:=", "Mag_5,Mag_15"), Array(_
  "NAME:UniteParameters", "CoordinateSystemID:=", -1, "KeepOriginals:=", _
  false)
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oEditor.Unite Array("NAME:Selections", "Selections:=", "Mag_6,Mag_16"), Array(_
  "NAME:UniteParameters", "CoordinateSystemID:=", -1, "KeepOriginals:=", _
  false)
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  "CoordinateSystemID:=", -1, "OriginX:=", "0", "OriginY:=", "0", "OriginZ:=", _
...
oEditor.Unite Array("NAME:Selections", "Selections:=", "Mag_7,Mag_17"), Array(_
  "NAME:UniteParameters", "CoordinateSystemID:=", -1, "KeepOriginals:=", _
  false)
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oEditor.Unite Array("NAME:Selections", "Selections:=", "Mag_8,Mag_18"), Array(_
  "NAME:UniteParameters", "CoordinateSystemID:=", -1, "KeepOriginals:=", _
  false)
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  "CoordinateSystemID:=", -1, "OriginX:=", "0", "OriginY:=", "0", "OriginZ:=", _
...
oEditor.Unite Array("NAME:Selections", "Selections:=", "Mag_9,Mag_19"), Array(_
  "NAME:UniteParameters", "CoordinateSystemID:=", -1, "KeepOriginals:=", _
  false)
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oModule.AssignTrueSurfOp Array("NAME:SurfApprox_Mag", "Objects:=", Array(_
  ...
  "Mag_8", "Mag_9"), "SurfDevChoice:=", 2, "SurfDev:=", "0.13085mm", _
...
oModule.AssignTrueSurfOp Array("NAME:SurfApprox_Main", "Objects:=", Array(_
  ...
  "SurfDevChoice:=", 2, "SurfDev:=", "0.20315mm", "NormalDevChoice:=", 2, _
...
oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "Band,InnerRegion" & _
  ...
  ",Mag_5,Mag_6,Mag_7,Mag_8,Mag_9", "Tool Parts:=", "Tool"), Array(_
...
oModule.InsertSetup "Transient", Array("NAME:Setup1", "FastReachSteadyState:=", _
  ...
  "450Hz", "StopTime:=", "0.02s", "TimeStep:=", "2e-05s")
Set oModule = oDesign.GetModule("BoundarySetup")
