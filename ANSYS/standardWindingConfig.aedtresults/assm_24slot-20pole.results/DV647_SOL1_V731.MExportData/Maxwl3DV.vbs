...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "DiaGap", "Value:=", "262.35mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "100mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "93.15629174003885mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "262.35mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "406.3mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "93.15629174003885mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
  "Value:=", "0deg"), Array("NAME:Pair", "Name:=", "Fractions", "Value:=", _
...
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "OuterRegion:CreateUserDefinedPart:1", "Length", "46.1mm + 2*endRegion"
On Error Goto 0
oEditor.SetPropertyValue "Geometry3DCmdTab", _
...
oModule.AssignMaster Array("NAME:Master", "Objects:=", Array("MasterSheet"), _
  ...
  "UPos:=", Array("203.15000000000001mm", "0mm", "0mm")), "ReverseV:=", true)
oModule.AssignSlave Array("NAME:Slave", "Objects:=", Array("SlaveSheet"), _
  Array("NAME:CoordSysVector", "Origin:=", Array("0mm", "0mm", "0mm"), _
  "UPos:=", Array("1.2439349862339241e-14mm", "203.15000000000001mm", "0mm")), _
  "ReverseV:=", true, "Master:=", "Master", "RelationIsSame:=", false)
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/SlotCore", "Version:=", "12.1", "NoOfParameters:=", 19, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "263mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "406.3mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "46.1mm"), Array("NAME:Pair", "Name:=", "Skew", "Value:=", _
  ...
  Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "45.5mm"), Array("NAME:Pair", _
  "Name:=", "Bs0", "Value:=", "15.1mm"), Array("NAME:Pair", "Name:=", "Bs1", _
  "Value:=", "18.37315590756558mm"), Array("NAME:Pair", "Name:=", "Bs2", _
  "Value:=", "30.3535331880186mm"), Array("NAME:Pair", "Name:=", "Rs", _
  ...
  "Name:=", "LenRegion", "Value:=", "93.15629174003885mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "2mm"), Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "45.5mm"), _
  Array("NAME:Pair", "Name:=", "Bs0", "Value:=", "15.1mm"), Array("NAME:Pair", _
  "Name:=", "Bs1", "Value:=", "18.37315590756558mm"), Array("NAME:Pair", _
  "Name:=", "Bs2", "Value:=", "30.3535331880186mm"), Array("NAME:Pair", _
  ...
  "Value:=", "93.15629174003885mm"), Array("NAME:Pair", "Name:=", "InfoCoil", _
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_0:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_1:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_2:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_3:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_4:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_5:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_6:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_7:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_8:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_9:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_10:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_11:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "261.7mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "100mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "46.1mm"), Array("NAME:Pair", "Name:=", "Poles", "Value:=", "20"), _
  Array("NAME:Pair", "Name:=", "PoleType", "Value:=", "2"), Array("NAME:Pair", _
  "Name:=", "D1", "Value:=", "259.7mm"), Array("NAME:Pair", "Name:=", "O1", _
  "Value:=", "0mm"), Array("NAME:Pair", "Name:=", "O2", "Value:=", _
  "67.27372110370993mm"), Array("NAME:Pair", "Name:=", "B1", "Value:=", _
  "12mm"), Array("NAME:Pair", "Name:=", "Rib", "Value:=", "2mm"), Array(_
  "NAME:Pair", "Name:=", "HRib", "Value:=", "11.26898099749231mm"), Array(_
  "NAME:Pair", "Name:=", "DminMag", "Value:=", "0mm"), Array("NAME:Pair", _
  "Name:=", "ThickMag", "Value:=", "12mm"), Array("NAME:Pair", "Name:=", _
  "WidthMag", "Value:=", "23.9mm"), Array("NAME:Pair", "Name:=", "LenRegion", _
  "Value:=", "93.15629174003885mm"), Array("NAME:Pair", "Name:=", "InfoCore", _
...
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  ...
  "0", "XAxisXvec:=", "0.987688", "XAxisYvec:=", "0.156434", "XAxisZvec:=", _
  "0", "YAxisXvec:=", "-0.156434", "YAxisYvec:=", "0.987688", "YAxisZvec:=", _
...
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  "CoordinateSystemID:=", -1, "OriginX:=", "0", "OriginY:=", "0", "OriginZ:=", _
  "0", "XAxisXvec:=", "-0.891007", "XAxisYvec:=", "-0.45399", "XAxisZvec:=", _
  "0", "YAxisXvec:=", "0.45399", "YAxisYvec:=", "-0.891007", "YAxisZvec:=", _
...
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  "CoordinateSystemID:=", -1, "OriginX:=", "0", "OriginY:=", "0", "OriginZ:=", _
  "0", "XAxisXvec:=", "-0.45399", "XAxisYvec:=", "-0.891007", "XAxisZvec:=", _
  "0", "YAxisXvec:=", "0.891007", "YAxisYvec:=", "-0.45399", "YAxisZvec:=", _
...
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  "CoordinateSystemID:=", -1, "OriginX:=", "0", "OriginY:=", "0", "OriginZ:=", _
  "0", "XAxisXvec:=", "0.156434", "XAxisYvec:=", "0.987688", "XAxisZvec:=", _
  "0", "YAxisXvec:=", "-0.987688", "YAxisYvec:=", "0.156434", "YAxisZvec:=", _
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "InnerRegion:CreateUserDefinedPart:1", "LenRegion", "46.1mm + 2*endRegion"
On Error Goto 0
Set oModule = oDesign.GetModule("MeshSetup")
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "57.84mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "InitPos:=", "9deg", "HasRotateLimit:=", false, "NonCylindrical:=", false, _
  "Consider Mechanical Transient:=", true, "Angular Velocity:=", "2700rpm", _
  "Moment of Inertia:=", 0.165581, "Damping:=", 0.00325285, "Load Torque:=", _
  "if(speed<282.743, -0.587758*speed, -46987.6/speed) - 0.587758*(speed-282.743)*10", _
  "Objects:=", Array("Band"))
...
oModule.CreateOutputVariable "pos", "(Moving1.Position -9 * PI/180) * 10 + PI", _
