...
edgeID = oEditor.GetEdgeByPosition(Array("NAME:Parameters", "BodyName:=", _
  "OuterRegion", "XPosition:=", "-216.05000000000001mm", "YPosition:=", _
  "2.6458494095578569e-14mm", "ZPosition:=", "0mm"))
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "26.14527927201807mm"), Array("NAME:Pair", "Name:=", "Bs2", "Value:=", _
  "41.76784976278806mm"), Array("NAME:Pair", "Name:=", "Rs", "Value:=", "5mm"), _
...
oModule.AssignTrueSurfOp Array("NAME:SurfApprox_Main", "Objects:=", Array(_
  ...
  "SurfDevChoice:=", 2, "SurfDev:=", "0.21605mm", "NormalDevChoice:=", 2, _
