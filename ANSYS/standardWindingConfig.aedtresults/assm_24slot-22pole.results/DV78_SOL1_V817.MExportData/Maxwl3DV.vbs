...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "DiaGap", "Value:=", "266.55mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "100mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "91.95097801822776mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "266.55mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "412.8mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "91.95097801822776mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
  "Value:=", "0deg"), Array("NAME:Pair", "Name:=", "Fractions", "Value:=", _
...
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "OuterRegion:CreateUserDefinedPart:1", "Length", "44.6mm + 2*endRegion"
On Error Goto 0
oEditor.SetPropertyValue "Geometry3DCmdTab", _
...
oModule.AssignMaster Array("NAME:Master", "Objects:=", Array("MasterSheet"), _
  ...
  "UPos:=", Array("206.40000000000001mm", "0mm", "0mm")), "ReverseV:=", true)
oModule.AssignSlave Array("NAME:Slave", "Objects:=", Array("SlaveSheet"), _
  Array("NAME:CoordSysVector", "Origin:=", Array("0mm", "0mm", "0mm"), _
  "UPos:=", Array("-206.40000000000001mm", "2.5276709934401372e-14mm", "0mm")), _
  "ReverseV:=", true, "Master:=", "Master", "RelationIsSame:=", false)
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/SlotCore", "Version:=", "12.1", "NoOfParameters:=", 19, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "267.2mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "412.8mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "44.6mm"), Array("NAME:Pair", "Name:=", "Skew", "Value:=", _
  ...
  Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "46.4mm"), Array("NAME:Pair", _
  "Name:=", "Bs0", "Value:=", "15.4mm"), Array("NAME:Pair", "Name:=", "Bs1", _
  "Value:=", "18.62214909919676mm"), Array("NAME:Pair", "Name:=", "Bs2", _
  "Value:=", "30.83950087530709mm"), Array("NAME:Pair", "Name:=", "Rs", _
  ...
  "Name:=", "LenRegion", "Value:=", "91.95097801822776mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "2mm"), Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "46.4mm"), _
  Array("NAME:Pair", "Name:=", "Bs0", "Value:=", "15.4mm"), Array("NAME:Pair", _
  "Name:=", "Bs1", "Value:=", "18.62214909919676mm"), Array("NAME:Pair", _
  "Name:=", "Bs2", "Value:=", "30.83950087530709mm"), Array("NAME:Pair", _
  ...
  "Value:=", "91.95097801822776mm"), Array("NAME:Pair", "Name:=", "InfoCoil", _
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_0:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_1:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_2:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_3:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_4:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_5:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_6:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_7:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_8:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_9:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_10:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_11:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "265.9mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "100mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "44.6mm"), Array("NAME:Pair", "Name:=", "Poles", "Value:=", "22"), _
  Array("NAME:Pair", "Name:=", "PoleType", "Value:=", "2"), Array("NAME:Pair", _
  "Name:=", "D1", "Value:=", "263.9mm"), Array("NAME:Pair", "Name:=", "O1", _
  "Value:=", "0mm"), Array("NAME:Pair", "Name:=", "O2", "Value:=", _
  "69.4659718873321mm"), Array("NAME:Pair", "Name:=", "B1", "Value:=", "12mm"), _
  Array("NAME:Pair", "Name:=", "Rib", "Value:=", "2mm"), Array("NAME:Pair", _
  "Name:=", "HRib", "Value:=", "11.39552138561267mm"), Array("NAME:Pair", _
  "Name:=", "DminMag", "Value:=", "0mm"), Array("NAME:Pair", "Name:=", _
  "ThickMag", "Value:=", "12mm"), Array("NAME:Pair", "Name:=", "WidthMag", _
  "Value:=", "22.1mm"), Array("NAME:Pair", "Name:=", "LenRegion", "Value:=", _
  "91.95097801822776mm"), Array("NAME:Pair", "Name:=", "InfoCore", "Value:=", _
...
oModule.AssignLengthOp Array("NAME:Length_Mag", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "24mm")
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/IPMCore", "Version:=", "19.0", "NoOfParameters:=", 16, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "265.9mm"), Array("NAME:Pair", "Name:=", _
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "InnerRegion:CreateUserDefinedPart:1", "LenRegion", "44.6mm + 2*endRegion"
On Error Goto 0
Set oModule = oDesign.GetModule("MeshSetup")
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "58.76mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2700rpm", "Moment of Inertia:=", 0.170727, "Damping:=", 0.00308638, _
  "Load Torque:=", _
  "if(speed<282.743, -0.588086*speed, -47013.9/speed) - 0.588086*(speed-282.743)*10", _
  "Objects:=", Array("Band"))
