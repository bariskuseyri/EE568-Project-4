...
edgeID = oEditor.GetEdgeByPosition(Array("NAME:Parameters", "BodyName:=", _
  "OuterRegion", "XPosition:=", "-206.40000000000001mm", "YPosition:=", _
  "2.5276709934401372e-14mm", "ZPosition:=", "0mm"))
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "Hs2", "Value:=", "46.4mm"), Array("NAME:Pair", "Name:=", "Bs0", _
  "Value:=", "15.4mm"), Array("NAME:Pair", "Name:=", "Bs1", "Value:=", _
  "18.62214909919676mm"), Array("NAME:Pair", "Name:=", "Bs2", "Value:=", _
  "30.83950087530709mm"), Array("NAME:Pair", "Name:=", "Rs", "Value:=", "5mm"), _
...
oModule.AssignTrueSurfOp Array("NAME:SurfApprox_Main", "Objects:=", Array(_
  ...
  "SurfDevChoice:=", 2, "SurfDev:=", "0.2064mm", "NormalDevChoice:=", 2, _
  "NormalDev:=", "15deg", "AspectRatioChoice:=", 1)
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
