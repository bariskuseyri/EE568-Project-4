...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "96.02130899487675mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oModule.AssignMaster Array("NAME:Master", "Objects:=", Array("MasterSheet"), _
  ...
  "UPos:=", Array("195.75mm", "0mm", "0mm")), "ReverseV:=", true)
oModule.AssignSlave Array("NAME:Slave", "Objects:=", Array("SlaveSheet"), _
  Array("NAME:CoordSysVector", "Origin:=", Array("0mm", "0mm", "0mm"), _
  "UPos:=", Array("1.198623054665472e-14mm", "195.75mm", "0mm")), _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "LenRegion", "Value:=", "96.02130899487675mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  Array("NAME:Pair", "Name:=", "Bs0", "Value:=", "14mm"), Array("NAME:Pair", _
  "Name:=", "Bs1", "Value:=", "17.72063077618766mm"), Array("NAME:Pair", _
  "Name:=", "Bs2", "Value:=", "29.1743980662911mm"), Array("NAME:Pair", _
  ...
  "Value:=", "96.02130899487675mm"), Array("NAME:Pair", "Name:=", "InfoCoil", _
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_9:CreateUserDefinedPart:1", "LenRegion", "49.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_10:CreateUserDefinedPart:1", "LenRegion", "49.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_11:CreateUserDefinedPart:1", "LenRegion", "49.6mm + 2*endRegion"
On Error Goto 0
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "96.02130899487675mm"), Array("NAME:Pair", "Name:=", "InfoCore", _
...
oModule.AssignLengthOp Array("NAME:Length_Mag", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "30mm")
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/IPMCore", "Version:=", "19.0", "NoOfParameters:=", 16, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "252.2mm"), Array("NAME:Pair", "Name:=", _
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "55.72mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "Band,InnerRegion" & _
  ...
  ",Mag_15", "Tool Parts:=", "Tool"), Array("NAME:SubtractParameters", _
