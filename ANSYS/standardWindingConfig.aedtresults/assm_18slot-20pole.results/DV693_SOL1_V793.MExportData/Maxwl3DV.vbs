...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "105.7590450947803mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "262.35mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "413.6mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "105.7590450947803mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
  "Value:=", "0deg"), Array("NAME:Pair", "Name:=", "Fractions", "Value:=", _
  "1"), Array("NAME:Pair", "Name:=", "HalfAxial", "Value:=", "0"), Array(_
  "NAME:Pair", "Name:=", "InfoCore", "Value:=", "100"))), Array(_
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "Bs0", "Value:=", "20.8mm"), Array("NAME:Pair", "Name:=", "Bs1", _
  "Value:=", "24.48762690592989mm"), Array("NAME:Pair", "Name:=", "Bs2", _
  "Value:=", "39.82807422756634mm"), Array("NAME:Pair", "Name:=", "Rs", _
  ...
  "Name:=", "LenRegion", "Value:=", "105.7590450947803mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "2mm"), Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "43.5mm"), _
  Array("NAME:Pair", "Name:=", "Bs0", "Value:=", "20.8mm"), Array("NAME:Pair", _
  "Name:=", "Bs1", "Value:=", "24.48762690592989mm"), Array("NAME:Pair", _
  "Name:=", "Bs2", "Value:=", "39.82807422756634mm"), Array("NAME:Pair", _
  ...
  "Value:=", "105.7590450947803mm"), Array("NAME:Pair", "Name:=", "InfoCoil", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "68.27372110370993mm"), Array("NAME:Pair", "Name:=", "B1", "Value:=", _
  "11mm"), Array("NAME:Pair", "Name:=", "Rib", "Value:=", "2mm"), Array(_
  "NAME:Pair", "Name:=", "HRib", "Value:=", "10.25651587170431mm"), Array(_
  "NAME:Pair", "Name:=", "DminMag", "Value:=", "0mm"), Array("NAME:Pair", _
  "Name:=", "ThickMag", "Value:=", "11mm"), Array("NAME:Pair", "Name:=", _
  "WidthMag", "Value:=", "23.9mm"), Array("NAME:Pair", "Name:=", "LenRegion", _
  "Value:=", "105.7590450947803mm"), Array("NAME:Pair", "Name:=", "InfoCore", _
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "60.76mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oEditor.Move Array("NAME:Selections", "Selections:=", "CoilTerm_0,CoilTerm_1" & _
  ...
  "TranslateVectorY:=", "0mm", "TranslateVectorZ:=", "11.525mm")
oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "Band,InnerRegion" & _
  ...
  ",Mag_14,Mag_15,Mag_16,Mag_17,Mag_18,Mag_19", "Tool Parts:=", "Tool"), _
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "InitPos:=", "11deg", "HasRotateLimit:=", false, "NonCylindrical:=", _
  false, "Consider Mechanical Transient:=", true, "Angular Velocity:=", _
  "2700rpm", "Moment of Inertia:=", 0.165581, "Damping:=", 0.00187754, _
  "Load Torque:=", _
  "if(speed<282.743, -0.587951*speed, -47003/speed) - 0.587951*(speed-282.743)*10", _
  "Objects:=", Array("Band"))
...
oModule.CreateOutputVariable "pos", _
  "(Moving1.Position -11 * PI/180) * 10 + PI", "Setup1 : Transient", _
  "Transient", Array() 
