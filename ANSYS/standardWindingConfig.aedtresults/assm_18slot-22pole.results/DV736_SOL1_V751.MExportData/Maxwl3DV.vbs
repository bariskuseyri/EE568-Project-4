...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "104.7511175823541mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "266.55mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "420.2mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "104.7511175823541mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
  "Value:=", "0deg"), Array("NAME:Pair", "Name:=", "Fractions", "Value:=", _
  "1"), Array("NAME:Pair", "Name:=", "HalfAxial", "Value:=", "0"), Array(_
  "NAME:Pair", "Name:=", "InfoCore", "Value:=", "100"))), Array(_
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "24.81875941983689mm"), Array("NAME:Pair", "Name:=", "Bs2", _
  "Value:=", "40.44132991060688mm"), Array("NAME:Pair", "Name:=", "Rs", _
  ...
  "Name:=", "LenRegion", "Value:=", "104.7511175823541mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "Bs1", "Value:=", "24.81875941983689mm"), Array("NAME:Pair", _
  "Name:=", "Bs2", "Value:=", "40.44132991060688mm"), Array("NAME:Pair", _
  ...
  "Value:=", "104.7511175823541mm"), Array("NAME:Pair", "Name:=", "InfoCoil", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "68.4659718873321mm"), Array("NAME:Pair", "Name:=", "B1", "Value:=", "13mm"), _
  Array("NAME:Pair", "Name:=", "Rib", "Value:=", "2mm"), Array("NAME:Pair", _
  "Name:=", "HRib", "Value:=", "12.4058046121507mm"), Array("NAME:Pair", _
  "Name:=", "DminMag", "Value:=", "0mm"), Array("NAME:Pair", "Name:=", _
  "ThickMag", "Value:=", "13mm"), Array("NAME:Pair", "Name:=", "WidthMag", _
  "Value:=", "22.1mm"), Array("NAME:Pair", "Name:=", "LenRegion", "Value:=", _
  "104.7511175823541mm"), Array("NAME:Pair", "Name:=", "InfoCore", "Value:=", _
...
oModule.AssignLengthOp Array("NAME:Length_Mag", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "26mm")
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/IPMCore", "Version:=", "19.0", "NoOfParameters:=", 16, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "265.9mm"), Array("NAME:Pair", "Name:=", _
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "61.72mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oEditor.Move Array("NAME:Selections", "Selections:=", "CoilTerm_0,CoilTerm_1" & _
  ...
  "TranslateVectorY:=", "0mm", "TranslateVectorZ:=", "11.15mm")
oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "Band,InnerRegion" & _
  ...
  ",Mag_14,Mag_15,Mag_16,Mag_17,Mag_18,Mag_19,Mag_20,Mag_21", _
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "InitPos:=", "11.8182deg", "HasRotateLimit:=", false, "NonCylindrical:=", _
  false, "Consider Mechanical Transient:=", true, "Angular Velocity:=", _
  "2700rpm", "Moment of Inertia:=", 0.170727, "Damping:=", 0.0017495, _
  "Load Torque:=", _
  "if(speed<282.743, -0.527778*speed, -42192.6/speed) - 0.527778*(speed-282.743)*10", _
  "Objects:=", Array("Band"))
...
oModule.CreateOutputVariable "pos", _
  "(Moving1.Position -11.8182 * PI/180) * 11 + PI", "Setup1 : Transient", _
  "Transient", Array() 
