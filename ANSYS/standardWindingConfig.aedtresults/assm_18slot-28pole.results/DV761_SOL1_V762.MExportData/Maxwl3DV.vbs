...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "102.7180328962783mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "277.45mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "437.4mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "102.7180328962783mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
  "Value:=", "0deg"), Array("NAME:Pair", "Name:=", "Fractions", "Value:=", _
  "1"), Array("NAME:Pair", "Name:=", "HalfAxial", "Value:=", "0"), Array(_
  "NAME:Pair", "Name:=", "InfoCore", "Value:=", "100"))), Array(_
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "46.5mm"), Array("NAME:Pair", _
  "Name:=", "Bs0", "Value:=", "22.2mm"), Array("NAME:Pair", "Name:=", "Bs1", _
  "Value:=", "25.71733492798495mm"), Array("NAME:Pair", "Name:=", "Bs2", _
  "Value:=", "42.1157441338722mm"), Array("NAME:Pair", "Name:=", "Rs", _
  ...
  "Name:=", "LenRegion", "Value:=", "102.7180328962783mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "2mm"), Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "46.5mm"), _
  Array("NAME:Pair", "Name:=", "Bs0", "Value:=", "22.2mm"), Array("NAME:Pair", _
  "Name:=", "Bs1", "Value:=", "25.71733492798495mm"), Array("NAME:Pair", _
  "Name:=", "Bs2", "Value:=", "42.1157441338722mm"), Array("NAME:Pair", _
  ...
  "Value:=", "102.7180328962783mm"), Array("NAME:Pair", "Name:=", "InfoCoil", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "67.08877183138307mm"), Array("NAME:Pair", "Name:=", "B1", "Value:=", _
  "20mm"), Array("NAME:Pair", "Name:=", "Rib", "Value:=", "2mm"), Array(_
  "NAME:Pair", "Name:=", "HRib", "Value:=", "19.67937387969526mm"), Array(_
  "NAME:Pair", "Name:=", "DminMag", "Value:=", "0mm"), Array("NAME:Pair", _
  "Name:=", "ThickMag", "Value:=", "20mm"), Array("NAME:Pair", "Name:=", _
  "WidthMag", "Value:=", "18.1mm"), Array("NAME:Pair", "Name:=", "LenRegion", _
  "Value:=", "102.7180328962783mm"), Array("NAME:Pair", "Name:=", "InfoCore", _
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "64.24mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oEditor.Move Array("NAME:Selections", "Selections:=", "CoilTerm_0,CoilTerm_1" & _
  ...
  "TranslateVectorY:=", "0mm", "TranslateVectorZ:=", "10.300000000000001mm")
oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "Band,InnerRegion" & _
  ...
  ",Mag_24,Mag_25,Mag_26,Mag_27", "Tool Parts:=", "Tool"), Array(_
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "InitPos:=", "13.5714deg", "HasRotateLimit:=", false, "NonCylindrical:=", _
  false, "Consider Mechanical Transient:=", true, "Angular Velocity:=", _
  "2700rpm", "Moment of Inertia:=", 0.185206, "Damping:=", 0.000858814, _
  "Load Torque:=", _
  "if(speed<282.743, -0.126449*speed, -10108.8/speed) - 0.126449*(speed-282.743)*10", _
  "Objects:=", Array("Band"))
...
oModule.CreateOutputVariable "pos", _
  "(Moving1.Position -13.5714 * PI/180) * 14 + PI", "Setup1 : Transient", _
  "Transient", Array() 
