...
edgeID = oEditor.GetEdgeByPosition(Array("NAME:Parameters", "BodyName:=", _
  "OuterRegion", "XPosition:=", "-218.69999999999999mm", "YPosition:=", _
  "2.6783025497352613e-14mm", "ZPosition:=", "0mm"))
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Name:=", "Hs2", "Value:=", "46.5mm"), Array("NAME:Pair", "Name:=", "Bs0", _
  "Value:=", "22.2mm"), Array("NAME:Pair", "Name:=", "Bs1", "Value:=", _
  "25.71733492798495mm"), Array("NAME:Pair", "Name:=", "Bs2", "Value:=", _
  "42.1157441338722mm"), Array("NAME:Pair", "Name:=", "Rs", "Value:=", "5mm"), _
...
oModule.AssignCoil Array("NAME:PhARe_0", "Objects:=", Array("Coil_1"), _
  ...
  "PhaseA")
oModule.AssignCoil Array("NAME:PhARe_1", "Objects:=", Array("Coil_2"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhA_1", "Objects:=", Array("Coil_3"), _
  "Conductor number:=", "conds", "PolarityType:=", "Positive", "Winding:=", _
  "PhaseA")
...
oModule.AssignCoil Array("NAME:PhCRe_3", "Objects:=", Array("Coil_7"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseC")
oModule.AssignCoil Array("NAME:PhCRe_4", "Objects:=", Array("Coil_8"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseC")
oModule.AssignCoil Array("NAME:PhC_4", "Objects:=", Array("Coil_9"), _
  "Conductor number:=", "conds", "PolarityType:=", "Positive", "Winding:=", _
  "PhaseC")
...
oModule.AssignCoil Array("NAME:PhB_7", "Objects:=", Array("Coil_15"), _
  "Conductor number:=", "conds", "PolarityType:=", "Positive", "Winding:=", _
  "PhaseB")
oModule.AssignCoil Array("NAME:PhARe_8", "Objects:=", Array("Coil_16"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhA_8", "Objects:=", Array("Coil_17"), _
  "Conductor number:=", "conds", "PolarityType:=", "Positive", "Winding:=", _
  "PhaseA")
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
...
oModule.AssignTrueSurfOp Array("NAME:SurfApprox_Mag", "Objects:=", Array(_
  ...
  "Mag_22", "Mag_23", "Mag_24", "Mag_25", "Mag_26", "Mag_27"), _
  "SurfDevChoice:=", 2, "SurfDev:=", "0.1384mm", "NormalDevChoice:=", 2, _
...
oModule.AssignTrueSurfOp Array("NAME:SurfApprox_Main", "Objects:=", Array(_
  ...
  "SurfDevChoice:=", 2, "SurfDev:=", "0.2187mm", "NormalDevChoice:=", 2, _
  "NormalDev:=", "15deg", "AspectRatioChoice:=", 1)
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "Band,InnerRegion" & _
  ...
  ",Mag_19,Mag_20,Mag_21,Mag_22,Mag_23,Mag_24,Mag_25,Mag_26,Mag_27", _
