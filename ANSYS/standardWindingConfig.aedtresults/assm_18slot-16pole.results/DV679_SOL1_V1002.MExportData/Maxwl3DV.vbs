...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "108.1748344595251mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "252.8mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "398.5mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "108.1748344595251mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
  "Value:=", "0deg"), Array("NAME:Pair", "Name:=", "Fractions", "Value:=", _
  "1"), Array("NAME:Pair", "Name:=", "HalfAxial", "Value:=", "0"), Array(_
  "NAME:Pair", "Name:=", "InfoCore", "Value:=", "100"))), Array(_
...
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "OuterRegion:CreateUserDefinedPart:1", "Length", "49.6mm + 2*endRegion"
On Error Goto 0
oEditor.SetPropertyValue "Geometry3DCmdTab", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "DiaYoke", "Value:=", "398.5mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "49.6mm"), Array("NAME:Pair", "Name:=", "Skew", "Value:=", _
  ...
  Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "41.5mm"), Array("NAME:Pair", _
  "Name:=", "Bs0", "Value:=", "20mm"), Array("NAME:Pair", "Name:=", "Bs1", _
  "Value:=", "23.61310099536467mm"), Array("NAME:Pair", "Name:=", "Bs2", _
  "Value:=", "38.24824039416727mm"), Array("NAME:Pair", "Name:=", "Rs", _
  ...
  "Name:=", "LenRegion", "Value:=", "108.1748344595251mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "2mm"), Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "41.5mm"), _
  Array("NAME:Pair", "Name:=", "Bs0", "Value:=", "20mm"), Array("NAME:Pair", _
  "Name:=", "Bs1", "Value:=", "23.61310099536467mm"), Array("NAME:Pair", _
  "Name:=", "Bs2", "Value:=", "38.24824039416727mm"), Array("NAME:Pair", _
  ...
  "Value:=", "108.1748344595251mm"), Array("NAME:Pair", "Name:=", "InfoCoil", _
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_0:CreateUserDefinedPart:1", "LenRegion", "49.6mm + 2*endRegion"
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/LapCoil", "Version:=", "12.0", "NoOfParameters:=", 21, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_1:CreateUserDefinedPart:1", "LenRegion", "49.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_2:CreateUserDefinedPart:1", "LenRegion", "49.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_3:CreateUserDefinedPart:1", "LenRegion", "49.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_4:CreateUserDefinedPart:1", "LenRegion", "49.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_5:CreateUserDefinedPart:1", "LenRegion", "49.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_6:CreateUserDefinedPart:1", "LenRegion", "49.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_7:CreateUserDefinedPart:1", "LenRegion", "49.6mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_8:CreateUserDefinedPart:1", "LenRegion", "49.6mm + 2*endRegion"
On Error Goto 0
...
oModule.AssignCoilTerminal Array("NAME:PhA_0", "Objects:=", Array("CoilTerm_0"), _
  ...
  "Winding:=", "PhaseA")
oModule.AssignCoilTerminal Array("NAME:PhBRe_1", "Objects:=", Array(_
...
oModule.AssignCoilTerminal Array("NAME:PhBRe_2", "Objects:=", Array(_
  ...
  true, "Winding:=", "PhaseB")
oModule.AssignCoilTerminal Array("NAME:PhC_3", "Objects:=", Array("CoilTerm_3"), _
  "Conductor number:=", "conds", "Point out of terminal:=", false, _
  "Winding:=", "PhaseC")
oModule.AssignCoilTerminal Array("NAME:PhARe_4", "Objects:=", Array(_
  "CoilTerm_4"), "Conductor number:=", "conds", "Point out of terminal:=", _
  true, "Winding:=", "PhaseA")
oModule.AssignCoilTerminal Array("NAME:PhARe_5", "Objects:=", Array(_
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "DiaYoke", "Value:=", "100mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "49.6mm"), Array("NAME:Pair", "Name:=", "Poles", "Value:=", "16"), _
  ...
  "65.23286396506127mm"), Array("NAME:Pair", "Name:=", "B1", "Value:=", "9mm"), _
  Array("NAME:Pair", "Name:=", "Rib", "Value:=", "2mm"), Array("NAME:Pair", _
  "Name:=", "HRib", "Value:=", "7.804506267174602mm"), Array("NAME:Pair", _
  "Name:=", "DminMag", "Value:=", "0mm"), Array("NAME:Pair", "Name:=", _
  "ThickMag", "Value:=", "9mm"), Array("NAME:Pair", "Name:=", "WidthMag", _
  "Value:=", "28.7mm"), Array("NAME:Pair", "Name:=", "LenRegion", "Value:=", _
  "108.1748344595251mm"), Array("NAME:Pair", "Name:=", "InfoCore", "Value:=", _
  "0"))), Array("NAME:Attributes", "Name:=", "Rotor", "Flags:=", "", _
  "Color:=", "(132 132 193)", "Transparency:=", 0, "PartCoordinateSystem:=", _
  "Global", "MaterialName:=", "AK_3DSF0.950", "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "MaterialName:=", "Arnold_Magnetics_N50H_60C_3DSF1.000_X", "SolveInside:=", _
  true) 
On Error Resume Next
...
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  "CoordinateSystemID:=", -1, "OriginX:=", "0", "OriginY:=", "0", "OriginZ:=", _
  "0", "XAxisXvec:=", "0.55557", "XAxisYvec:=", "-0.83147", "XAxisZvec:=", _
  "0", "YAxisXvec:=", "0.83147", "YAxisYvec:=", "0.55557", "YAxisZvec:=", "0"), _
...
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  "CoordinateSystemID:=", -1, "OriginX:=", "0", "OriginY:=", "0", "OriginZ:=", _
  "0", "XAxisXvec:=", "0.83147", "XAxisYvec:=", "0.55557", "XAxisZvec:=", "0", _
  "YAxisXvec:=", "-0.55557", "YAxisYvec:=", "0.83147", "YAxisZvec:=", "0"), _
  Array("NAME:Attributes", "Name:=", "relativeCS_9")
oEditor.SetWCS Array("NAME:RSetWCS Parameter", "Working Coordinate System:=", _
  "Global")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
  "NAME:Geometry3DAttributeTab", Array("NAME:PropServers", "Mag_9"), Array(_
...
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  "CoordinateSystemID:=", -1, "OriginX:=", "0", "OriginY:=", "0", "OriginZ:=", _
  "0", "XAxisXvec:=", "-0.55557", "XAxisYvec:=", "-0.83147", "XAxisZvec:=", _
  "0", "YAxisXvec:=", "0.83147", "YAxisYvec:=", "-0.55557", "YAxisZvec:=", _
...
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  "CoordinateSystemID:=", -1, "OriginX:=", "0", "OriginY:=", "0", "OriginZ:=", _
  "0", "XAxisXvec:=", "0.83147", "XAxisYvec:=", "-0.55557", "XAxisZvec:=", _
  "0", "YAxisXvec:=", "0.55557", "YAxisYvec:=", "0.83147", "YAxisZvec:=", "0"), _
  Array("NAME:Attributes", "Name:=", "relativeCS_14")
oEditor.SetWCS Array("NAME:RSetWCS Parameter", "Working Coordinate System:=", _
  "Global")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oModule.AssignLengthOp Array("NAME:Length_Mag", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "18mm")
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/IPMCore", "Version:=", "19.0", "NoOfParameters:=", 16, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "252.2mm"), Array("NAME:Pair", "Name:=", _
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "58.52mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oEditor.Move Array("NAME:Selections", "Selections:=", "CoilTerm_0,CoilTerm_1" & _
  ...
  "TranslateVectorY:=", "0mm", "TranslateVectorZ:=", "12.4mm")
oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "Band,InnerRegion" & _
  ...
  ",Mag_14,Mag_15", "Tool Parts:=", "Tool"), Array(_
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "InitPos:=", "8.75deg", "HasRotateLimit:=", false, "NonCylindrical:=", _
  false, "Consider Mechanical Transient:=", true, "Angular Velocity:=", _
  "2700rpm", "Moment of Inertia:=", 0.153658, "Damping:=", 0.00213754, _
  "Load Torque:=", _
  "if(speed<282.743, -0.588009*speed, -47007.7/speed) - 0.588009*(speed-282.743)*10", _
  "Objects:=", Array("Band"))
oModule.EditMotionSetup Array("NAME:Data", "Consider Mechanical Transient:=", _
  false)
Set oModule = oDesign.GetModule("AnalysisSetup")
oModule.InsertSetup "Transient", Array("NAME:Setup1", "StopTime:=", "0.03s", _
  "TimeStep:=", "3e-05s")
Set oModule = oDesign.GetModule("BoundarySetup")
...
oModule.CreateOutputVariable "pos", _
  "(Moving1.Position -8.75 * PI/180) * 8 + PI", "Setup1 : Transient", _
  "Transient", Array() 
