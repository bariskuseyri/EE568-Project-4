...
oModule.AssignCoilTerminal Array("NAME:PhARe_0", "Objects:=", Array(_
  "CoilTerm_0"), "Conductor number:=", 29, "Point out of terminal:=", true, _
  "Winding:=", "PhaseA")
oModule.AssignCoilTerminal Array("NAME:PhARe_1", "Objects:=", Array(_
  "CoilTerm_1"), "Conductor number:=", 29, "Point out of terminal:=", true, _
  "Winding:=", "PhaseA")
oModule.AssignCoilTerminal Array("NAME:PhA_2", "Objects:=", Array("CoilTerm_2"), _
  "Conductor number:=", 29, "Point out of terminal:=", false, "Winding:=", _
  "PhaseA")
oModule.AssignCoilTerminal Array("NAME:PhBRe_3", "Objects:=", Array(_
  "CoilTerm_3"), "Conductor number:=", 29, "Point out of terminal:=", true, _
  "Winding:=", "PhaseB")
oModule.AssignCoilTerminal Array("NAME:PhBRe_4", "Objects:=", Array(_
  "CoilTerm_4"), "Conductor number:=", 29, "Point out of terminal:=", true, _
  "Winding:=", "PhaseB")
...
oEditor.Move Array("NAME:Selections", "Selections:=", "CoilTerm_0,CoilTerm_1" & _
  ...
  "TranslateVectorY:=", "0mm", "TranslateVectorZ:=", "10.85mm")
