...
oModule.AssignSlave Array("NAME:Slave", "Objects:=", Array("SlaveSheet"), _
  Array("NAME:CoordSysVector", "Origin:=", Array("0mm", "0mm", "0mm"), _
  "UPos:=", Array("-135.09999999999999mm", "1.6544978256480741e-14mm", "0mm")), _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "WidthMag", "Value:=", "20mm"), Array("NAME:Pair", "Name:=", "LenRegion", _
  "Value:=", "79.64513471840652mm"), Array("NAME:Pair", "Name:=", "InfoCore", _
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2700rpm", "Moment of Inertia:=", 0.0416044, "Damping:=", 0.00154966, _
  "Load Torque:=", _
  "if(speed<282.743, -0.588023*speed, -47008.8/speed) - 0.588023*(speed-282.743)*10", _
  "Objects:=", Array("Band"))
