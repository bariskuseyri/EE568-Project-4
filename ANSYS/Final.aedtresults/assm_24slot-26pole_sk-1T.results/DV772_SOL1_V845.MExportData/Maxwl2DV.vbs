...
edgeID = oEditor.GetEdgeByPosition(Array("NAME:Parameters", "BodyName:=", _
  "OuterRegion", "XPosition:=", "-201.505mm", "YPosition:=", _
  "2.4677245326218741e-14mm", "ZPosition:=", "0mm"))
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "12.32mm"), Array("NAME:Pair", "Name:=", "Bs1", "Value:=", _
  "22.73820448984385mm"), Array("NAME:Pair", "Name:=", "Bs2", "Value:=", _
  "35.37684425823385mm"), Array("NAME:Pair", "Name:=", "Rs", "Value:=", "5mm"), _
...
oModule.AssignTrueSurfOp Array("NAME:SurfApprox_Main", "Objects:=", Array(_
  ...
  "SurfDevChoice:=", 2, "SurfDev:=", "0.201505mm", "NormalDevChoice:=", 2, _
