...
INTERN  R        Ra  N1:=A, N2:=N0_1  ( R:=0.0177067 ); 
INTERN  R        Rb  N1:=B, N2:=N0_2  ( R:=0.0177067 ); 
INTERN  R        Rc  N1:=C, N2:=N0_3  ( R:=0.0177067 ); 
INTERN  L        La  N1:=N0_1, N2:=N0_4  ( L:=0.00500569, I0:=0 ); 
INTERN  L        Lb  N1:=N0_2, N2:=N0_5  ( L:=0.00500569, I0:=0 ); 
INTERN  L        Lc  N1:=N0_3, N2:=N0_6  ( L:=0.00500569, I0:=0 ); 
...
INTERN  E        BVmd  N1:=N_31, N2:=N_25  ( EMF:=0.00585138 * N_4.V * VImq.I, PARTDERIV:=1 ); 
INTERN  L        Lad  N1:=N_31, N2:=N_33  ( L:=7.39297e-05, I0:=0 ); 
...
INTERN  E        BVmq  N1:=N_32, N2:=N_26  ( EMF:=-0.000961087 * N_4.V * VImd.I, PARTDERIV:=1 ); 
INTERN  L        Laq  N1:=N_32, N2:=N_34  ( L:=0.000450106, I0:=0 ); 
INTERN  AM       VImq  N1:=N_34, N2:=GND  ; 
INTERN  E        Bkea  N1:=GND, N2:=N_10  ( EMF:=1.30277 * sin(N_8.V), PARTDERIV:=1 ); 
INTERN  VM       VM_kea  N1:=N_10, N2:=GND  ; 
INTERN  E        Bkeb  N1:=GND, N2:=N_11  ( EMF:=-1.30277 * cos(N_8.V), PARTDERIV:=1 ); 
INTERN  VM       VM_keb  N1:=N_11, N2:=GND  ; 
INTERN  I        BTm  N1:=GND, N2:=N_4  ( IS:=(VIa.I*N_10.V + VIb.I*N_11.V), PARTDERIV:=1 ); 
INTERN  I        BTdq  N1:=GND, N2:=N_4  ( IS:=0.00489029 * VI1d.I * VI1q.I, PARTDERIV:=1 ); 
